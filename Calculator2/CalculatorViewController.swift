...
class CalculatorViewController: UIViewController, DestinationViewControllerDelegate {
    ...
    @IBAction func operationAction(_ sender: UIButton) {
        ...
        case Operations.percent.rawValue:
            ...
            // Reset currentlyTypingNumber and finishedEquation
        ...
        case Operations.equals.rawValue:
            ...
            // Reset currentlyTypingNumber back to false
            calculator.currentlyTypingNumber = false
    ...
    func passNumberBack(data: [Any]) {
        ...
        case "+", "-", "x", "÷":
            ...
            if currentStack == "+" || currentStack == "-" || currentStack == "x" || currentStack == "÷" {
                ...
                //Since neither stacks end with an operator: Remove last number from selected histroy stack, merge that stack with the operationStack, then set the resultTextLabel to the last removed object of history stack
